...
The code-writing mindset is very different from the documentation-writing mindset. Usually you will find that your code comments are too specific, that you presume too much knowledge of the context in which a method is called. This is because when you're writing a method you usually immerse yourself so deeply in a particular use case that you can't see beyond that situation (eg, why someone might be in that situation and how they got there). This is necessary for writing code, and useless for explaining it.
