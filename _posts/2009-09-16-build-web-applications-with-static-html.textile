...
Aspect-oriented programming solves the cross-cutting problem by _weaving_. I'm not sure that a similar technique can (or should) be used for multiple web applications, but by implementing features as services instead of plugins we can achieve the sort of auto-pull feature we seek. 
