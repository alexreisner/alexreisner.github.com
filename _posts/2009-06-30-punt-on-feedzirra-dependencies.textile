...
If you're having trouble installing Feedzirra I encourage you to evaluate whether you really need it. In my application I did the following to accomplish most of what was covered in Railscast #168 on a Twitter feed:


h2. 1. Install libxml-ruby

The libxml-ruby parser is quite fast. If you're using REXML or hpricot to parse XML you should consider switching as the difference in speed is *significant*. To install, add the following to <tt>config/environment.rb</tt> in your Rails app:
